...
//    QString VVVV_IP_2 = "169.254.255.255";
    ...
    widgetChemin_commonModelA_1->setOSCCommand("/VVVV/someCommand");
    widgetChemin_commonModelA_1->setOSCSendIP(VVVV_IP_2);
    ...
    widgetChemin_commonModelA_2->setOSCCommand("/VVVV/someCommand");
    widgetChemin_commonModelA_2->setOSCSendIP(VVVV_IP_2);
    ...
    widgetChemin_commonModelA_3->setOSCCommand("/VVVV/someCommand");
    widgetChemin_commonModelA_3->setOSCSendIP(VVVV_IP_2);
    ...
    widgetChemin_commonModelA_4->setOSCCommand("/VVVV/someCommand");
    widgetChemin_commonModelA_4->setOSCSendIP(VVVV_IP_2);
    ...
    widgetChemin_commonModelA_5->setOSCCommand("/VVVV/someCommand");
    widgetChemin_commonModelA_5->setOSCSendIP(VVVV_IP_2);
    ...
    widgetChemin_commonModelA_6->setOSCCommand("/VVVV/someCommand");
    widgetChemin_commonModelA_6->setOSCSendIP(VVVV_IP_2);
    ...
    widgetChemin_commonModelA_7->setOSCCommand("/VVVV/someCommand");
    widgetChemin_commonModelA_7->setOSCSendIP(VVVV_IP_2);
    ...
    widgetChemin_commonModelA_8->setOSCCommand("/VVVV/someCommand");
    widgetChemin_commonModelA_8->setOSCSendIP(VVVV_IP_2);
    ...
    widgetChemin_commonModelA_9->setOSCCommand("/VVVV/someCommand");
    widgetChemin_commonModelA_9->setOSCSendIP(VVVV_IP_2);
