...
void MyObjectOSCNetCore::sendDatagramInDifferentMode(QString oscString, int _port, bool _mode)
{
    OSCNetcore_sendToPort = _port;
    if(!_mode)
    {
...
void MyObjectOSCNetCore::sendOSCMessageDataGram(QString _oscString)
{
...
void MyObjectOSCNetCore::sendOSCBundleDataGram(QString _oscString)
{
...
QByteArray MyObjectOSCNetCore::OSCNetCore_oscMessageToDataGram(QString _s)
{
    QByteArray _r;
...
QByteArray MyObjectOSCNetCore::OSCNetCore_oscBundleToDataGram(QString _s)
{
    QByteArray _return;
...
QByteArray MyObjectOSCNetCore::_FourByteFormat(QByteArray _src)
{
    QByteArray _return;
